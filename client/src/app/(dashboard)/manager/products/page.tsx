...
const Items = ({
  ...
  <div className="rounded grid grid-cols-8 text-md hover:border-2 hover:shadow-xl duration-200 transition-all gap-1 relative">
      ...
      <Carousel className="relative w-full">
        <CarouselContent>
          {photos && photos.length > 0 ? (
            ...
            <CarouselItem key="placeholder">No Image</CarouselItem>
          )}
        </CarouselContent>
      </Carousel>
    </div>
